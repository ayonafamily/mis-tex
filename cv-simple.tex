...
\begin{document}
    ...
    \begin{header}
        \fontsize{25 pt}{25 pt}\selectfont Jorge Ayona
        \vspace{5 pt}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{mailto:ayonafamily@gmail.com}{ayonafamily@gmail.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{tel:+51 995 121512}{+51 995 121512}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://jorgeayona.com/}{jorgeayona.com}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
